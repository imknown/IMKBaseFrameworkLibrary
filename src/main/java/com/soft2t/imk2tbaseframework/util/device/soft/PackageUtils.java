...
public class PackageUtils {
	...
	/**
	 * 32位: /vendor/lib:/system/lib<br>
	 * 64位: /vendor/lib64:/system/lib64<br>
	 * 通用: /vendor/lib*:/system/lib*
	 */
	// public static final String LD_LIBRARY_PATH = "/vendor/lib:/system/lib:/vendor/lib64:/system/lib64";
	public static final String LD_LIBRARY_PATH = "/vendor/lib*:/system/lib*";
	...
	public static int installSilent(Context context, String filePath, String pmParams) {
		 ...
		 **/
		StringBuilder command = new StringBuilder().append("LD_LIBRARY_PATH=" + LD_LIBRARY_PATH + " pm install ").append(pmParams == null ? "" : pmParams).append(" ").append(filePath.replace(" ", "\\ "));
	...
	public static int uninstallSilent(Context context, String packageName, boolean isKeepData) {
		 ...
		 **/
		StringBuilder command = new StringBuilder().append("LD_LIBRARY_PATH=" + LD_LIBRARY_PATH + " pm uninstall").append(isKeepData ? " -k " : " ").append(packageName.replace(" ", "\\ "));
		CommandResult commandResult = ShellUtils.execCommand(command.toString(), !isSystemApplication(context), true);
		if (commandResult.successMsg != null && (commandResult.successMsg.contains("Success") || commandResult.successMsg.contains("success"))) {
	...
	/**
	 * get app version code by packageName
	 * 
	 * @param context
	 * @return
	 */
	...
	public static int getInstallLocation() {
		CommandResult commandResult = ShellUtils.execCommand("LD_LIBRARY_PATH=" + LD_LIBRARY_PATH + " pm get-install-location", false, true);
